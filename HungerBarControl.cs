...
public class HungerBarControl : MonoBehaviour {
	...
	*/
	...
	{
		bool bUpdate = false;
		if( current_param != DataManager.Instance.dataChara.hunger)
		{
			bUpdate = true;
		}
		else if( max_param != DataManager.Instance.dataChara.hunger_max)
		{
			bUpdate = true;
		}
		else
		...
		if( bUpdate)
		{
			ParamUpdate(DataManager.Instance.dataChara.hunger, DataManager.Instance.dataChara.hunger_max);
		}
	}
